"""Below code is taken directly from https://github.com/hpc203/yolov8-face-landmarks-opencv-dnn/tree/main and only made small visualization adjustments"""
...
class YOLOv8_face:
    ...
    def draw_detections(self, image, boxes, scores, kpts):
        eye_indices = [0, 1]  # This assumes the first two keypoints correspond to the eyes
        for box, score, kp in zip(boxes, scores, kpts):
            ...
            for i in range(5):
                color = (0, 255, 0) if i == 0 else (255, 0, 0) if i == 1 else  (0, 0, 255) # Red for eyes, green for others
                cv2.circle(image, (int(kp[i * 3]), int(kp[i * 3 + 1])), 4, color, thickness=-1)
        return image
